-- CreateEnum
CREATE TYPE "TokenType" AS ENUM ('RESET_PASSWORD', 'INVITE');
...
-- CreateIndex
CREATE INDEX "i_email_idx" ON "i"("email");

-- CreateIndex
CREATE UNIQUE INDEX "i_email_organization_id_key" ON "i"("email", "organization_id");
...
-- AddForeignKey
ALTER TABLE "i" ADD CONSTRAINT "i_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "i" ADD CONSTRAINT "i_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
